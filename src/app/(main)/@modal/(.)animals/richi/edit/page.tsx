...
export default function EditRichiModalPage() {
  ...
  const onSubmit = (e: React.FormEvent<HTMLFormElement>) => {
    ...
    console.log("ANIMAL CARD UPDATE (RICHI MODAL)", Object.fromEntries(fd.entries()));
        ...
        <div className={overlay.scrollBox}>
          <form className={a.formCard} onSubmit={onSubmit}>
            ...
            <div className={a.field}>
              ...
              <input id="name" name="name" type="text" className={a.input} defaultValue="Ричи" />
            </div>
            ...
            <div className={a.field}>
              ...
              <input id="species" name="species" type="text" className={a.input} defaultValue="Собака" />
            </div>
            ...
            <div className={a.field}>
              ...
              <input id="breed" name="breed" type="text" className={a.input} defaultValue="Лабрадор" />
            </div>
            ...
            <div className={a.field}>
              ...
              <input id="age" name="age" type="text" className={a.input} defaultValue="1 год" />
            </div>
